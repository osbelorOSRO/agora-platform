...
| `fastapi_microservicio` | Si | En stack app por perfil | sin estado critico propio |
...
| `mongo` | No (operativo) | Fuera de repo (`/root/bd`) | volumenes/datos/backups fuera de git |
