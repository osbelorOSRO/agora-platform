...
export class BaileysIngressEnvelopeDto {
  ...
  @ApiProperty({
    description: 'ID externo del actor (JID de WhatsApp) origen del evento.',
    maxLength: 255,
    example: '56912345678@s.whatsapp.net',
  })
  @IsString()
  @MinLength(1)
  @MaxLength(255)
  ...
  @ApiProperty({ description: 'Proveedor del evento.', enum: ['BAILEYS'] })
  @IsString()
  @IsIn(['BAILEYS'])
  provider!: 'BAILEYS';

  @ApiProperty({ description: 'Tipo de objeto origen.', enum: ['WHATSAPP'] })
  @IsString()
  @IsIn(['WHATSAPP'])
  objectType!: 'WHATSAPP';
