...
required_vars=(
  ...
  VAULT_INTERNAL_URL REDIS_INTERNAL_URL WHISPER_INTERNAL_URL TESSERACT_INTERNAL_URL
  MEDIA_BASE_URL SOCKET_HTTP_PUBLIC_URL SERVICE_ALLOWED_IPS
  API_DATABASE_URL ABACKEND_DATABASE_URL
